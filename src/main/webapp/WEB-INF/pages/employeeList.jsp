    ...
    <div class="panel panel-success">
        <div class="panel-heading">
            <h3 class="panel-title">
                ...
                <div align="right"><a href="${pageContext.request.contextPath}/employee/add">Add New Employee</a></div>
            </h3>
        </div>
                ...
                <table class="table table-hover table-bordered">
                    ...
                    <c:forEach items="${employeeList}" var="emp">
                        <tr>
                        	...
                        	<th><a href="${pageContext.request.contextPath}/employee/edit?id=<c:out value='${emp.id}'/>">Edit</a></th>
                        	<th><a href="${pageContext.request.contextPath}/employee/delete?id=<c:out value='${emp.id}'/>">Delete</a></th>                         	
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
