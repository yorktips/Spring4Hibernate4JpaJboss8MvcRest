    ...
    <div class="container myrow-container">
        <div class="panel panel-success">
            ...
            <div class="panel-body">
                <form:form id="employeeRegisterForm" cssClass="form-horizontal" modelAttribute="employee" method="post" action="${pageContext.request.contextPath}/employee/save">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                ...
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                <input type="button" id="retrunMain" class="btn btn-primary" value="Cancel" onclick="returnMain();"/>
                            </div>
                            <div class="col-xs-4">
